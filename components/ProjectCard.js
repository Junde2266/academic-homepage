...
export default function ProjectCard({
  ...
  return (
    <Link href={`projects/${slug}`} className="">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 border-neutral-200 dark:border-neutral-700 border w-full md:h-72 rounded-xl bg-white dark:bg-neutral-800 hover:shadow-sm overflow-hidden">
